...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-12 font-sans font-normal antialiased selection:bg-blue-500 selection:text-white">
      <motion.div 
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {error && (
                <motion.div 
                  ...
                  className="p-3.5 bg-red-500/10 border border-red-200 rounded-xl text-xs text-red-700 font-medium"
                >
                  {error}
                </motion.div>
              )}
              ...
              <motion.button
                ...
                disabled={isLoading}
                type="submit"
                className="w-full bg-[#0053db] hover:bg-[#004ac6] text-white font-semibold text-sm py-3.5 px-6 rounded-2xl shadow-[0_4px_18px_rgba(0,83,219,0.3)] hover:shadow-[0_8px_24px_rgba(0,83,219,0.4)] transition-all duration-200 flex justify-center items-center gap-2 mt-4 disabled:opacity-75 disabled:cursor-not-allowed cursor-pointer"
              >
                {isLoading ? (
