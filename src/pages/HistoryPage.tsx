      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col">
        ...
        <div className="p-4 md:p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-center bg-slate-50/60 gap-4">
          <div className="relative w-full max-w-md">
            ...
            <input
              type="text"
              placeholder="Filter berdasarkan nama pasien atau ID..."
              value={filterText}
              onChange={(e) => {
                setFilterText(e.target.value);
                setCurrentPage(1);
              }}
              className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-semibold placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100/80 transition-all font-sans focus:outline-none"
            />
          </div>
          <div className="flex gap-2 select-none">
            <span className="text-[10px] font-bold text-slate-450 bg-slate-100 border border-slate-200 px-3 py-1 rounded-full uppercase tracking-wider">
                ...
                {paginated.length > 0 ? (
                  paginated.map((item) => (
                    ...
                    >
                      ...
                      <td className="py-4.5 px-6 text-xs text-slate-450 select-text">
                      ...
                      <td className="py-4.5 px-6 text-center select-none">
                        <span className="inline-flex items-center justify-center px-2 py-0.5 bg-blue-50 border border-blue-100 text-blue-800 rounded-md text-[10px] font-bold">
                  ...
                  <tr className="select-none">
                    <td colSpan={7} className="py-16 text-center">
                      <div className="flex flex-col items-center justify-center max-w-[280px] mx-auto py-4">
                        <div className="p-4 bg-slate-50 rounded-full border border-slate-200 mb-4">
